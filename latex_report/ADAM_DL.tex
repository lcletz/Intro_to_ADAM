...
\par On observe qu'Adagrad converge rapidement vers une faible erreur initiale, mais stagne ensuite, tandis qu'Adam continue à améliorer l'erreur au fil des \textit{epochs}. Adagrad converge le plus lentement, RMSprop plus rapidement, et à partir de 2 epochs, SGD suit la même trajectoire qu'Adam.
